...
public class OrderBuilder extends ABuilderPane {
	...
	public OrderBuilder(ADataEntryWindow mainWindow) {
		super(mainWindow);
		report = mainWindow.mainWindow.getTurnReport();
		turn = mainWindow.mainWindow.getCurrentTurn();
	}
	...
	protected void createWidgets(List<Widget> widgets) {
		...
		Group buttonPanel = new Group(getParent(),SWT.NONE);
		...
		add.addListener(SWT.Selection, new Listener() {
			public void handleEvent (Event event) {
				...
				turn.add(order);
				mainWindow.mainWindow.setTurnDirty(true);
			}
		});
		widgets.add(add);

		Group orderSelectionPanel = new Group(getParent(),SWT.NONE);
		orderSelectionPanel.setText("Type");
		...
		widgets.add(orderSelectionPanel);
